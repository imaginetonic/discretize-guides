...
import gg from "./images/gg.jpg?width=300;720;1080&format=webp;jpg&meta"
import mistlocked from "./images/mistlocked.png?width=100&format=webp;jpg&meta"

import los from "./videos/lospull.webm"
...
<MDImage meta={mistlocked} caption="[FotM]"/>
...
<MDImage meta={gg} caption="A dead player"/>
...
<GridItem>
<GifPlayer caption="Pulling mobs by using Line of Sight" url={los} />
</GridItem>
</Grid>
